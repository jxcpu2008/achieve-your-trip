package cn.atrip.api.gateway.controller.impl;
...
public class LoginController extends BasicController implements LoginControllerI {
	...
	@Override
	@ApiOperation(value = "用户退出API", notes = "退出系统")
	...
	@ApiOperation(value = "用户注册API", notes = "测试注册的接口")
